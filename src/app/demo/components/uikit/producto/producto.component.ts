...
export class ProductoComponent implements OnInit {
    ...
    eliminarProducto() {
        ...
        this.multiService.eliminarProductoById(this.currentProducto.codigoP)
        .subscribe(
            res => {
                console.log(res)
            }
     ...
     calcular(valorr: number):void{
        ...
        //this.costoU = suma;
        //this.myForm.value.utilidad1 = utilidad
        console.log(utilidad)
        
        //this.myForm.value.costo_u = suma
        
    //    console.log(this.costoU)
        //this.myForm.value.costo_u as this.costo_u;
    //    this.costoU = this.myForm.value.costo_u

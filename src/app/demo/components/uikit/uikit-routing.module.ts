...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'formproduc', data: { breadcrumb: 'Form Produc' }, loadChildren: () => import('./Formproduc/formproduc.module').then(m => m.formProducModule) },
        { path: 'formProducA', data: { breadcrumb: 'Form ProducA' }, loadChildren: () => import('./formProducA/formproductA.module').then(m => m.formProducAModule) },
        { path: 'edit/:producto', data: { breadcrumb: 'Product' }, loadChildren: () => import('./producto/producto.module').then(m => m.ProducAModule) },
